...
//
translate([0,x_carriage_base_size[1]+80, 0]) rotate ([0,0,180])
x_end_idler();
x_end_motor();
//x_end_bottom();
//x_end_bottom(end_stop=true);

translate([0,x_carriage_base_size[1],conf_lb_out_dia(bushing_x)/2+x_carriage_base_size[2]+0.1]) rotate ([0,180,180]) x_carriage();
