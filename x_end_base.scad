...
module bushing_mount_screws(screw_length=12) {
		...
		// Nut traps
		translate([x_end_bushing_mount_hole_spacing/2, screw_length, z_bushing_foot_height-6]) rotate([90, 0, 0]) nut_hole(type=z_bushing_mounting_nut, h=screw_length-6);
		translate([-x_end_bushing_mount_hole_spacing/2, screw_length, z_bushing_foot_height-6]) rotate([90, 0,0]) nut_hole(type=z_bushing_mounting_nut, h=screw_length-6);
		translate([x_end_bushing_mount_hole_spacing/2, screw_length, 6]) rotate([90, 0, 0]) nut_hole(type=z_bushing_mounting_nut, h=screw_length-6);
       	translate([-x_end_bushing_mount_hole_spacing/2, screw_length, 6]) rotate([90, 0,0]) nut_hole(type=z_bushing_mounting_nut, h=screw_length-6);
}
...
module x_end_idler() {
	...
	difference(){
		union(){
			...
			// idler wall
			translate([x_end_base_size[0]/2-idler_wall_thickness/2,0,idler_wall_height/2+x_end_base_size[2]/2-0.005]) cube_fillet([idler_wall_thickness,x_end_base_size[1],idler_wall_height-x_end_base_size[2]+0.01], center=true, vertical=[0,0,0,0], top=[bearing_out_dia(idler_bearing)/2,0,bearing_out_dia(idler_bearing)/2,0]);	//idler wall
			translate([(x_end_base_size[0]/2)+1, screw_dia(v_screw_hole(idler_screw, $fn=8))/2, idler_height]) rotate([0,-90,0]) rotate([0,0,180/8]) cylinder_poly(r1=screw_dia(v_screw_hole(idler_screw, $fn=8))*cos(180/8)/2+2,r2=screw_dia(v_screw_hole(idler_screw, $fn=8))*cos(180/8)/2+3.5, h=1.1, $fn=8);
			
			// outside idler wall
			translate([x_end_base_size[0]/2+idler_wall_thickness/2+2+bearing_width(idler_bearing)+0.1,0,idler_wall_height/2+x_end_base_size[2]/2-0.005]) cube_fillet([idler_wall_thickness,x_end_base_size[1],idler_wall_height-x_end_base_size[2]+0.01], center=true, vertical=[5,0,0,5], top=[bearing_out_dia(idler_bearing)/2,0,bearing_out_dia(idler_bearing)/2,0]);	//idler wall
			translate([(x_end_base_size[0]/2)+2+bearing_width(idler_bearing)+0.1, screw_dia(v_screw_hole(idler_screw, $fn=8))/2, idler_height]) rotate([0,-90,0]) rotate([0,0,180/8]) cylinder_poly(r2=screw_dia(v_screw_hole(idler_screw, $fn=8))*cos(180/8)/2+2,r1=screw_dia(v_screw_hole(idler_screw, $fn=8))*cos(180/8)/2+3.5, h=1.1, $fn=8);
			
			// idler wall bottom support
			translate([x_end_base_size[0]/2+(idler_wall_thickness+2+bearing_width(idler_bearing)+0.1)/2,0,x_end_base_size[2]/2]) cube_fillet([idler_wall_thickness+2+bearing_width(idler_bearing)+0.1,x_end_base_size[1],x_end_base_size[2]], center=true, vertical=[5,0,0,5]);
			
			// idler wall rear support
			translate([x_end_base_size[0]/2+(2+bearing_width(idler_bearing)+0.1)/2,-x_end_base_size[1]/2+idler_wall_thickness/2,idler_wall_height/2+x_end_base_size[2]/2-0.005]) cube_fillet([2+bearing_width(idler_bearing)+0.1,idler_wall_thickness,idler_wall_height-x_end_base_size[2]+0.01], vertical=[0,0,0,0], top=[0,0,bearing_out_dia(idler_bearing)/2,0], center=true);
			
			//translate([x_end_base_size[0]/2-3,0,idler_wall_height/2+x_end_base_size[2]/2-0.005]) cube_fillet([6,x_end_base_size[1],idler_wall_height-x_end_base_size[2]+0.01], center=true, vertical=[0,0,0,0], top=[bearing_out_dia(idler_bearing)/2,0,bearing_out_dia(idler_bearing)/2,0]);	//idler wall
			
			//front idler wall bridge
			difference() {
				translate([x_end_base_size[0]/2-idler_wall_thickness-7,x_end_base_size[1]/4,idler_wall_height/2+x_end_base_size[2]/2-0.005]) cube_fillet([14,x_end_base_size[1]/2,idler_wall_height-x_end_base_size[2]+0.01], center=true, vertical=[0,0,0,0], top=[bearing_out_dia(idler_bearing)/2,0,0,0]);	//idler wall
				translate([x_end_base_size[0]/2-idler_wall_thickness-12-1,x_end_base_size[1]/2+3,x_end_base_size[2]-0.005]) cylinder_poly(r=13.5, h=idler_wall_height-x_end_base_size[2]+0.01);	//idler wall
			}
		...
		// idler screw hole
		translate([(x_end_base_size[0]/2+idler_wall_thickness+2+bearing_width(idler_bearing)+0.1), screw_dia(v_screw_hole(idler_screw, $fn=8))/2, idler_height]) rotate([0,-90,0]) screw_hole(type=idler_screw, h=12+idler_wall_thickness*2+2+bearing_width(idler_bearing)+0.1, $fn=8);
		
		// cutout for screw hole
		translate([(x_end_base_size[0]/2)-12/2-idler_wall_thickness-0.01, screw_dia(v_screw_hole(idler_screw, $fn=8))/4, idler_height]) cube([12,screw_dia(v_screw_hole(idler_screw, $fn=8))/2+0.02,screw_dia(v_screw_hole(idler_screw, $fn=8))*cos(180/8)],center=true);
		
		// idler nut trap
		translate([(x_end_base_size[0]/2)-idler_wall_thickness -0.01, screw_dia(v_screw_hole(idler_screw, $fn=8))/2, idler_height]) rotate([-90,0,90]) nut_slot_hole(type=idler_nut, h=17);
		...
		translate([0,x_end_base_size[1]/2-y_offset,x_end_base_size[2]+0.01]) nut_hole(type=lead_screw_nut, h=z_bushing_foot_height+1.01);
...
module x_end_motor() {
	...
	difference(){
		union(){
			...
			difference() {
				translate([-x_end_base_size[0]/2, -x_end_base_size[1]/2-0.1, x_end_base_size[2]-0.01]) cube_fillet([(x_end_base_size[0]-x_end_bushing_mount_wall_width)/2+0.1, x_end_base_size[1]/2+7+0.1,idler_wall_height-x_end_base_size[2] + 0.01], vertical=[0,11,0,0], top=[0,0,0,0]);	//idler wall
				...
				cylinder_poly(r=sagitta_radius((x_end_base_size[0]-x_end_bushing_mount_wall_width)/2-x_end_motor_wall_thickness, x_end_base_size[1]/2+7-(z_bushing_mount_thickness+7)), h=idler_wall_height-x_end_base_size[2]+0.02);	//idler wall
			}
		}
		translate([0,0,x_end_base_size[2]+1]) bushing_mount_screws(screw_length=12);
...
module x_end_bottom() {
	difference() {
		...
		// rod clamp screw holes
		translate([0,0,x_end_base_size[2]]) {
			translate([smooth_rod_clamp_screw_hole_spacing_x/2,smooth_rod_clamp_screw_hole_spacing_y/2,0]) rotate ([180,0,0]) screw_hole(type=smooth_rod_clamp_screw, h=x_end_base_size[2], head_drop=0);
			translate([-smooth_rod_clamp_screw_hole_spacing_x/2,smooth_rod_clamp_screw_hole_spacing_y/2,0]) rotate ([180,0,0]) screw_hole(type=smooth_rod_clamp_screw, h=x_end_base_size[2], head_drop=0);
		...
		translate([0,x_end_base_size[1]/2-y_offset,-x_end_base_clamp_gap/2]) nut_hole(type=lead_screw_nut);
	}
}
...
%translate([(x_end_base_size[0]/2)+1+bearing_width(idler_bearing), screw_dia(v_screw_hole(idler_screw, $fn=8))/2, idler_height]) rotate([0,-90,0]) idler(idler_bearing=idler_bearing);
...
//translate([0,x_end_base_size[1]/2-lead_screw_to_smooth_rod_separation-y_offset,z_bushing_foot_height/2+x_end_base_size[2]+1]) rotate([0,0,-90]) linear_bearing_clamp_with_foot(length=z_bushing_foot_height);
