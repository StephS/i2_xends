...
module leadscrew_coupling(){
    union(){
        difference(){
            ...
            //shaft groves
            translate([ -coupling_size[0]/2-0.1, 0, coupling_size[2]+lead_screw_coupling_gap/2]) rotate([0,90,0]) rod_hole(d=screw_dia(lead_screw)+lead_screw_coupling_tubing_wall_thickness*2, h=coupling_size[0]/2+0.1, horizontal=true);
...
translate([0, 14, 0]) leadscrew_coupling();
translate([0, -14, 0]) leadscrew_coupling();