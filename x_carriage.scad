	...
	difference () {
		union () {
			...
			difference() {
				...
				translate([x_axis_smooth_rod_separation/2+(conf_lb_out_dia(bushing_x)/2 + bushing_clamp_outer_radius_add)/2, 0, ((x_carriage_base_support_thickness+x_carriage_base_size[2])+0.1)/2]) cube([(conf_lb_out_dia(bushing_x)/2 + bushing_clamp_outer_radius_add),x_carriage_base_size[1],(x_carriage_base_support_thickness+x_carriage_base_size[2])+0.2], center=true);
				translate([x_axis_smooth_rod_separation/2, 0, conf_lb_out_dia(bushing_x)/2+x_carriage_base_size[2]+0.1]) rotate([90,0,0]) cylinder_poly(r = conf_lb_out_dia(bushing_x)/2 + 0.02, h=x_carriage_base_size[1]+0.2, center=true);
				translate([-x_axis_smooth_rod_separation/2-(conf_lb_out_dia(bushing_x)/2 + bushing_clamp_outer_radius_add)/2, 0, ((x_carriage_base_support_thickness+x_carriage_base_size[2])+0.1)/2]) cube([(conf_lb_out_dia(bushing_x)/2 + bushing_clamp_outer_radius_add),x_carriage_base_size[1],(x_carriage_base_support_thickness+x_carriage_base_size[2])+0.2], center=true);
				translate([-x_axis_smooth_rod_separation/2, 0, conf_lb_out_dia(bushing_x)/2+x_carriage_base_size[2]+0.1]) rotate([90,0,0]) cylinder_poly(r = conf_lb_out_dia(bushing_x)/2 + 0.02, h=x_carriage_base_size[1]+0.2, center=true);
			}
			// bearing holders
			translate([0, 0, conf_lb_out_dia(bushing_x)/2+x_carriage_base_size[2]+0.1]) {
				translate([x_axis_smooth_rod_separation/2,x_carriage_base_size[1]/2-(conf_lb_length(bushing_x)+bushing_retainer_add)/2, 0]) rotate([90,-90,180]) linear(conf_b = bushing_x, center=true, wide_base=true);
				translate([x_axis_smooth_rod_separation/2,-(x_carriage_base_size[1]/2-(conf_lb_length(bushing_x)+bushing_retainer_add)/2), 0]) rotate([90,-90,180]) linear(conf_b = bushing_x, center=true, wide_base=true);
				translate([-x_axis_smooth_rod_separation/2,x_carriage_base_size[1]/2-(conf_lb_length(bushing_x)+bushing_retainer_add)/2, 0]) rotate([90,-90,0]) linear(conf_b = bushing_x, center=true, wide_base=true);
				translate([-x_axis_smooth_rod_separation/2,-(x_carriage_base_size[1]/2-(conf_lb_length(bushing_x)+bushing_retainer_add)/2), 0]) rotate([90,-90,0]) linear(conf_b = bushing_x, center=true, wide_base=true);
			}
			// end stop flag
			//translate([x_carriage_base_size[0]/2-0.1,x_carriage_base_size[1]/2-15,0])
			//	cube_fillet([(end_stop_mount_thickness+end_stop_size[1]/2)+screw_head_top_dia(v_screw_hole(end_stop_flag_screw))/2+3+0.1, 15, (conf_lb_out_dia(bushing_x)/2+x_carriage_base_size[2]+0.1-(end_stop_plate_size[0]-end_stop_hole_spacing[0])/2-end_stop_button_loc_from_screw)+screw_head_top_dia(v_screw_hole(end_stop_flag_screw))/2+3], vertical=[3,0,0,3], top=[3,0,3,3]);			// belt tensioner slide through
			...
			translate([-x_carriage_base_size[0]/2-(belt_width+x_carriage_belt_clamp_nut_support_outer_dia+x_carriage_belt_clamp_screw_offset+x_carriage_belt_clamp_offset),x_carriage_belt_clamp_width/2-2,0])
			...
			translate([-x_carriage_base_size[0]/2-(belt_width+x_carriage_belt_clamp_nut_support_outer_dia+x_carriage_belt_clamp_screw_offset+x_carriage_belt_clamp_offset),-(x_carriage_belt_clamp_width*1.5-2),0])
				cube_fillet([belt_width+x_carriage_belt_clamp_nut_support_outer_dia+x_carriage_belt_clamp_screw_offset+x_carriage_belt_clamp_offset+0.1, x_carriage_belt_clamp_width, x_carriage_base_size[2]], vertical=[0,5,5,0]);
			// belt tensioner
		...
		// belt clamp tensioner belt cutout
		translate([-x_carriage_base_size[0]/2-(belt_width+x_carriage_belt_clamp_offset),-0.1+x_carriage_belt_clamp_width/2-2,-0.1]) cube([belt_width, x_carriage_belt_clamp_width+0.2, belt[4]]);
		...
		// belt clamp tensioner belt cutout
		translate([-x_carriage_base_size[0]/2-(belt_width+x_carriage_belt_clamp_offset), -(0.1+x_carriage_belt_clamp_width*1.5-2),-0.1]) cube([belt_width, x_carriage_belt_clamp_width+0.2, belt[4]]);
		// belt clamp tensioner screw
		translate([-x_carriage_base_size[0]/2-(belt_width+x_carriage_belt_clamp_offset+x_carriage_belt_clamp_screw_offset), -(x_carriage_belt_clamp_width-2),0]) screw_hole(type=x_carriage_belt_clamp_screw);
		// belt clamp tensioner screw inside
		translate([-x_carriage_base_size[0]/2-x_carriage_belt_clamp_offset+x_carriage_belt_clamp_screw_offset, -(x_carriage_belt_clamp_width-2),0]) screw_hole(type=x_carriage_belt_clamp_screw);
		...
		//	translate([(end_stop_mount_thickness+end_stop_size[1]/2),0,(conf_lb_out_dia(bushing_x)/2+x_carriage_base_size[2]+0.1-(end_stop_plate_size[0]-end_stop_hole_spacing[0])/2-end_stop_button_loc_from_screw)]) {
